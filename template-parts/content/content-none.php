		...
		<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
			<p>
				...
				printf(
					...
					wp_kses( __( 'Ready to publish your first post? <a href="%s">Get started here</a>.', 'uppa-base' ), array( 'a' => array( 'href' => array() ) ) ),
					esc_url( admin_url( 'post-new.php' ) )
				);
				?>
			</p>
		<?php elseif ( is_search() ) : ?>
			<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'uppa-base' ); ?></p>
			<?php get_search_form(); ?>
		<?php else : ?>
